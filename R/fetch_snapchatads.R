#' fetch_snapchatads
#' A function to fetch Snapchat Ads data from the windsor.ai API
#'
...
#' @examples
#' \dontrun{
#' my_snapchatads_data <- fetch_snapchatads(api_key = "your api key",
...
fetch_snapchatads <-
  function(api_key,
    ...
    json_data <- jsonlite::fromJSON(
      paste0(
        "https://connectors.windsor.ai/snapchat?api_key=",
        api_key,
        "&fields=",
